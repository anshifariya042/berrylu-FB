...
//             className="border border-gray-300 rounded-full pl-10 pr-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-pink-400 shadow-sm"
//           />
...
//         <nav
//           className={`${menuOpen
//             ? "flex flex-col w-full bg-gray-50 shadow-md p-4 space-y-4 mt-2"
//             : "hidden md:flex"
...
//             </div>
//           ) : (
//             <Link to="/login" onClick={() => setMenuOpen(false)} className="flex items-center space-x-2">
